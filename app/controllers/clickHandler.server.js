	...
	this.getUserPolls = function (req, res) {
		...
		Polls
			...
			.exec(function (err, result) {
				...
				let formattedOutput = '';
				result.forEach((e) => {
					formattedOutput += `<tr><td>${e.title}</td><td><a class='viewCtrl' href='${e._id}'><i class='fa fa-2x fa-eye'></i></a></td><td><a class='delCtrl' href='javascript:;'><i class='fa fa-2x fa-minus-circle'></i></a></td></tr>`;
				});
				res.json(formattedOutput);
			});
	};
